...
[![My Skills](https://skillicons.dev/icons?i=java,cpp,c,python,ruby,rust,linux,html,javascript,typescript,css,react,tailwind,docker,figma,cs,git,github,vscode,eclipse,mongodb,mysql,postgres&perline=10)](https://skillicons.dev)
